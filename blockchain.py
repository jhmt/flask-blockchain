...
class BlockChain(object):
    ...
    def valid_proof(self, transactions,
        previous_hash, nonce,
        diffculty=MINING_DIFFICULTY):
        ...
        return guess_hash[:diffculty] == '0'*diffculty
    ...
    def proof_of_work(self):
        ...
        while self.valid_proof(
            transactions, previous_hash, nonce) is False:
            nonce += 1
        return nonce
    ...
    def mining(self):
        ...
        logger.info({'action': 'mininig', 'status': 'success'})
        return True
